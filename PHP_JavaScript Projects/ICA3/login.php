...
<body>
    ...
    <div class="section">
        <form action="#" method="POST" name="myForm">
            ...
            <label for="username" style="text-align:left; padding-left:10px;"> (admin)</label>

            <label for="password">Password: </label>
            <input type="password" name="password" id="password" placeholder="Supply your password">
            <label for="username" style="text-align:left; padding-left:10px;"> (god)</label>
