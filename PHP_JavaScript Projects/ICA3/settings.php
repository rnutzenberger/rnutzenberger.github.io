...
<head>
    ...
    <script src="jsfolder/settings.js"></script>
</head>
    <div id="hdr"><?php echo "ICA03 - Settings : {$_SESSION["username"]}"; ?></div>
...
<body>
    ...
    <div class="section">
        ...
        <div></div>
        <div></div>
        <div><input type="button" id="btnBack" value="Go Back" style="width: 100%;"></div>
    </div>
